...
[ExecuteInEditMode]
public class arTrackedArena : MonoBehaviour
{
    ...
    public static bool visible = false;                 // Current visibility from tracking
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (baseMarker != null && marker.Visible)
                    {
                        ...
                        //    ok = new Vector3(ARUtilityFunctions.PositionFromMatrix(pose).x + x, ARUtilityFunctions.PositionFromMatrix(pose).y, ARUtilityFunctions.PositionFromMatrix(pose).z);
                        //}
                        //else
                        //{
                        //    ok = ARUtilityFunctions.PositionFromMatrix(pose);
                        //}
